...
if NUM_ADV_EPOCHS > 0:
    ...
    # print('Adversarial Accuracy-\tEval: {:.2f}%.'.format(trainer.eval(eval_dataloader, adversarial=True)*100))
    # # print('Adversarial Accuracy-\tTrain: {:.2f}%.'.format(trainer.train(train_dataloader, epoch=0, adversarial=True)['adversarial_acc'] * 100))
    # print('Adversarial Accuracy-\tTest: {:.2f}%.'.format(trainer.eval(test_dataloader, adversarial=True) * 100))
