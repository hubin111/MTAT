...
parser.add_argument('--model-path', default='/root/SCORE/trained_models/WRN34-10Swish_cifar10/weights-best.pt', help='model path')
# dataset dependent
...
for clean_idx in range(num_eval_imgs):
    ...
    for i in range(num_batches):
        ...
        x_batch_adv, predicted = attack(model, inputs, target_inputs, labels, config_feature_attack)
