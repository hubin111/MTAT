...
def parser_train():
    ...
    # parser.add_argument('--pretrained-file', type=str, default='/root/SCORE/trained_models/WRN34-10Swish_cifar10/', help='Pretrained weights file name.')
    parser.add_argument('--pretrained-file', type=str, default='/root/SCORE/trained_models/mymodel/',help='Pretrained weights file name.')
    # parser.add_argument('--pretrained-file', type=str, default='/root/SCORE/trained_models/WRN28-10Swish_cifar10s_wuqiong/', help='Pretrained weights file name.')
    ...
    parser.add_argument('-a', '--attack', type=str, choices=ATTACKS, default='linf-pgd', help='Type of attack.')#l2-pgd
    #parser.add_argument('-a', '--attack', type=str, choices=ATTACKS, default='l2-pgd',help='Type of attack.')  # l2-pgd
    ...
    parser.add_argument('--aux-data-filename', type=str, help='Path to additional Tiny Images data.', 
                        default='/root/SCORE/ti_500K_pseudo_labeled.pickle')
...
def parser_eval():
    ...
    # eval-rb.py
    parser.add_argument('--threat', type=str, default='Linf', choices=['corruptions', 'Linf', 'L2'],
